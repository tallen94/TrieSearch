...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Assignment2_Cloud" generation="1" functional="0" release="0" Id="7a7d4a52-5e3a-4ef2-a359-a214e13e7888" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="Assignment2_CloudGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="TrieSearch" generation="1" functional="0" release="0" software="C:\Users\Trevor\Info344\Assignment2_Cloud\Assignment2_Cloud\csx\Debug\roles\TrieSearch" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="50e00c2e-6ffb-4cde-87b6-aef1311b062a" ref="Microsoft.RedDog.Contract\ServiceContract\Assignment2_CloudContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="a7c17fc6-d0c1-4e92-90da-2dc3704b6eeb" ref="Microsoft.RedDog.Contract\Interface\TrieSearch:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Assignment2_Cloud/Assignment2_CloudGroup/TrieSearch:Endpoint1" />
          </inPort>
        </interfaceReference>
